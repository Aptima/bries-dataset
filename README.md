...
# Abstract
Generative AI is reshaping organizational communication by rapidly producing persuasive counter-narratives that compete with official messaging. This paper introduces a dataset of 134,136 LLM-generated persuasion attacks against 972 press releases from ten agencies. Attacks are produced by GPT-4, Gemma-2, and Llama-3.1 across 23 SemEval-2023 Task 3 techniques and two media: long-form press statements and short-form social posts. Using moral foundation analysis, distinct patterns emerge: GPT-4 prioritizes Care with Authority and Loyalty secondary; Gemma-2 emphasizes Care and Authority; Llama-3.1 emphasizes Loyalty and Care. Findings show that model choice shapes persuasive style and exposes different vulnerabilities. The dataset and analysis support proactive defenses and more resilient institutional communication in AI-mediated information environments.

# Contributions
-	Introduced a large LLM-generated persuasion-attack dataset containing 134,136 persuasive attacks generated by GPT-4, Gemma 2, and Llama 3.1 targeting 972 press releases from 10 government and commercial agencies
...
-	**Building Reputation Armor**: Insights from this large LLM-generated persuasion-attack dataset help organizations reinforce the credibility and resilience of their messaging in the face of evolving information threats.
